    ...
    <ThemeProvider theme={theme}>
       ...
       <Box sx={{display:'flex', flexDirection:'row', flexWrap:'wrap', gap:5, justifyContent:'space-around'}}>
        ...
        sx={{display:'flex',paddingRight:1,flexDirection:'row',justifyContent:'center',border:'1px solid #4f6cf4',width:{xs:'90%',md:'40%'}, borderRadius:5, marginLeft:{xs:2,md:5}}}>
                <Box sx={{position:'relative',left:{xs:-25,md:-25,lg:-40},top:{xs:60,md:50,lg:40,xl:80},width:{xs:50,md:50,lg:70,xl:110},height:{xs:50,md:50,lg:70,xl:110},backgroundColor:'#4f6cf4', borderRadius:50, display:'flex', flexDirection:'row', alignItems:'center', justifyContent:'center'}}>
                    <ScreenSearchDesktopIcon sx={{color:'white',fontSize:{xs:'calc(1em + 2vw)',md:'calc(1em + 2vw)',lg:'calc(1em + 3vw)',xl:'calc(1em + 4vw)'}}}/>
                </Box>
                <Box sx={{width:'90%',py:2}}>
                    <Typography variant='h5' sx={{fontWeight:'bold', mb:2}}>Monitoreo de TI</Typography>
                    <Typography variant='body1'>Supervise su infraestructura de red, servidores físicos y virtuales y otros equipos. Generando información para ayudar a tu equipo en la continuidad de tu negocio.</Typography>
                </Box>
            </Box>
            ...
            <Box sx={{position:'relative',left:{xs:-25,md:-25,lg:-40},top:{xs:60,md:50,lg:40,xl:80},width:{xs:50,md:50,lg:80,xl:100},height:{xs:50,md:50,lg:80,xl:100},backgroundColor:'#4f6cf4', borderRadius:50, display:'flex', flexDirection:'row', alignItems:'center', justifyContent:'center'}}>
                ...
                <Box sx={{width:'90%',py:2}}>
                    ...
                    <Typography variant='body1'>Fácil diagnóstico de problemas con indicadores en tiempo real de equipos e infraestructura industrial, brindando información precisa para que cada nivel de operación pueda actuar de manera más eficiente.</Typography>
                </Box>
            </Box>
            ...
            sx={{display:'flex',paddingRight:1,flexDirection:'row',justifyContent:'center',border:'1px solid #4f6cf4',width:{xs:'90%',md:'40%'}, borderRadius:5, marginLeft:{xs:2,md:5}}}>
            <Box sx={{position:'relative',left:{xs:-25,md:-25,lg:-40},top:{xs:60,md:50,lg:40,xl:80},width:{xs:50,md:50,lg:80,xl:100},height:{xs:50,md:50,lg:80,xl:100},backgroundColor:'#4f6cf4', borderRadius:50, display:'flex', flexDirection:'row', alignItems:'center', justifyContent:'center'}}>
                    <MonitorHeartIcon  sx={{color:'white',fontSize:{xs:'calc(1em + 2vw)',md:'calc(1em + 2vw)',lg:'calc(1em + 3vw)',xl:'calc(1em + 4vw)'}}}/>
                </Box>
                <Box sx={{width:'90%',py:2}}>
                    <Typography variant='h5' sx={{fontWeight:'bold', mb:2}}>Monitoreando tu negocio</Typography>
                    <Typography variant='body1'>Cree indicadores de rendimiento para su ERP, CRM u otros sistemas, para que tenga una gestión de operaciones en tiempo real, respaldado por alertas y recomendaciones directamente.</Typography>
                </Box>
            </Box>
       </Box>
    </Box>
